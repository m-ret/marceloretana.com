...
export const alt = "Marcelo Retana | Desarrollo Web Costa Rica";
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        >
          Desarrollo full-stack con Next.js. Optimizado para SEO, rapido y disenado para generar
          clientes.
        </div>
      </div>
